...
const Form = () => {
    ...
    const handleResize = () => {
        ...
        if (window.innerWidth >= 1024) {
            setShopFormVisibile(true)
        } else {
            setShopFormVisibile(false)
        }
    }
    ...
    return (
        <div>
            ...
            <div className="lg:hidden">
                ...
                {!shopFormVisibile && <Button className='w-full mt-7' onClick={() => setShopFormVisibile(true)}>Create Shop +</Button>}

                {shopFormVisibile && <Button className='w-full mt-7' onClick={() => setShopFormVisibile(false)}>Remove Form -</Button>}

            </div>

            {shopFormVisibile && <div className="transition-transform">
